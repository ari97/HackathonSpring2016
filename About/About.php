<HTML><head><title>About Us</title></head>
   ...
   <body>
           <a href="../Signup/signup.php"><button type="button" class="btn btn-primary btn-lg" id="signup">Signup</button>
          ...
          <h1>
            ...
            <p> Marist Forums is a simple and innovative way for students, faculty, and staff to submit posts about the issues within certain departments on the campus. Founded by three Marist students (Ariel Camilo, Evan McElheny, and Trevor Pirone) users have the ability to upvote a post if they agree or downvote if they disagree.
	          ...
	          <h1>
  	          ...
  	          <p> <q>Marist is dedicated to helping students develop the intellect, character, and skills  required for enlightened, ethical, and productive lives in the global community of the 21st century.</q>
        ...
        <a href="../Index/index.php"><button type="button" class="btn btn-primary btn-lg" id="home">Home</button></a>
        <footer>
